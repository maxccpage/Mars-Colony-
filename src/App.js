  ...
  render() {
    return (
      <div className="home">
        ...
        <h6 className="homeh6"> Are you even ready though? There's aliens and shit </h6>
  ...
  render() {
    return (
      <div className="register">
        ...
        <h6 className="registerh6"> Seriously man, think about it! There's some big ass aliens out there! </h6>
        <p> Full Name </p>
  ...
  render() {
    return (
      <div className="view">
        ...
        <h6 className="viewh6"> Peeps below, recent Alien encounters and how they dealt with the shits! </h6>
